...
pkgver=4.19.67
pkgrel=1
_patch_release_tag=2.9.4 # release tag of kitakar5525/linux-surface-patches
...
sha256sums=('SKIP' # linux kernel source file
            'SKIP' # .tar.sign
            'b2a707698b26f22ff7bd8c39da679dcfde308d12bd1980a63c10da175e86750c' # upstream patch
            'SKIP' # config
