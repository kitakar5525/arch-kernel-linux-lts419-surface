...
pkgver=4.19.58
pkgrel=1
_patch_release_tag=2.5 # release tag of kitakar5525/linux-surface-patches
...
sha256sums=('SKIP' # linux kernel source file
            'SKIP' # .tar.sign
            '018584229e0522aa94cb7af7b7f0775cf42ae3873a8d4cbc8715d807719bfad5' # upstream patch
            'SKIP' # config
