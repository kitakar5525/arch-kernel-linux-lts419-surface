...
pkgver=4.19.61
pkgrel=1
_patch_release_tag=2.8.1 # release tag of kitakar5525/linux-surface-patches
...
sha256sums=('SKIP' # linux kernel source file
            'SKIP' # .tar.sign
            '68ffa9f14b80f19429b85deaf7e0cf66f4304d85fdfeb23d56e9233211d88826' # upstream patch
            'SKIP' # config
